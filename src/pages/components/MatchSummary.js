...
function MatchSummary(){
    ...
    return(
        <>
           <div className="match-half-container">
                                            <div className="match-half-row">

                                                <div className="match-half-time">
                                                    <div className="march-bg-time">
                                                        <span>1st Half</span>
                                                    </div>
                                                    <div className="march-bg-time">
                                                        <span> 2 -0 </span>
                                                ...
                                                <div className="match-half-team">
                                                    <div className="match-half-team-data">
                                                        18
                                                    </div>
                                                    <div className="match-half-team-data">
                                                        <div className="score-button-match"> <span className="heading-svg"><svg fill="#555e61" width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
